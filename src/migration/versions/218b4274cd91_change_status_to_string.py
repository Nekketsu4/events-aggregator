...
def downgrade() -> None:
    ...
    sa.Column('last_changed_at', sa.VARCHAR(length=50), autoincrement=False, nullable=True),
    ...
    sa.Column('status', postgresql.ENUM('registration_closed', 'published', name='eventstatus'), autoincrement=False, nullable=False),
